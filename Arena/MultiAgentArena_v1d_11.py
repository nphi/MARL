...
# Non-Social Environment without Partner Inputs
class MultiAgentArena_v1d_11(MultiAgentEnv):
    ...
    def step(self, action: dict):
        ...
        r1 = -0.5 if "collision" in events else 1.0 if "agent1_new_field" in events else -0.5
        r2 = -0.1 if "collision" in events else 0.1 if "agent2_new_field" in events else -0.1
    ...
    def _get_obs(self):
        ...
        # Set traversible space
        # state_tensor[1:11, 1:11, 2] = 1
        ...
        # provide observation only of self
        # agent_1
